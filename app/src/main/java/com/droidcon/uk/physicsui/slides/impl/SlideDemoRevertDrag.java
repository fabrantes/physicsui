 ...
 */
public class SlideDemoRevertDrag extends BaseSlide implements SpringListener {

    @Bind(R.id.interactive_demo_container) View mDemoContainer;
    @Bind(R.id.left_target) View mLeftTopTarget;
    @Bind(R.id.right_target) View mRightTopTarget;
    ...
    public SlideDemoRevertDrag(@NonNull Context context, @LayoutRes int layoutId) {
                ...
                MagneticDragTouchFilter.builder()
                        ...
                        .setListener(new MagneticDragTouchFilter.Listener() {
                            ...
                            public void onFinishDragging() {
                                ...
                                mDraggableTranslationXSpring.setEndValue(0);
                                mDraggableTranslationYSpring.setEndValue(0);
                            }
