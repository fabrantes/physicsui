 ...
 */
public class SlideImplementationOptions extends BaseSlide implements SpringListener {
    ...
    @NonNull private final Spring mParam1XSpring;
    @NonNull private final Spring mParam2PopSpring;

    public SlideImplementationOptions(@NonNull Context context, @LayoutRes int layoutId) {
        ...
        mParam1XSpring = springSystem.createSpring();

        mParam1PopSpring.addListener(this);
        mParam2PopSpring.addListener(this);
        mParam1XSpring.addListener(this);
    }
    ...
    protected void onSlideInflated(@NonNull View view, @NonNull ViewGroup parentView) {
        ...
        mParam1XSpring.setCurrentValue(Double.MIN_VALUE, true);
    ...
    public void onGlobalLayout() {
        ...
        final float param1X = mParam1TextView.getX();

        // Override initial positions, if needed.
        if (mParam1XSpring.getCurrentValue() == Double.MIN_VALUE && param1X != 0) {
            mParam1XSpring.setCurrentValue(param1X);
        }

        // Dynamic tweening.
        mParam1TextView.setX((float) mParam1XSpring.getCurrentValue());
        mParam1XSpring.setEndValue(param1X);
    }
    ...
    public void onSpringUpdate(Spring spring) {
        ...
        } else if (spring == mParam1XSpring) {
            mParam1TextView.setX(value);
        }
    }
}
